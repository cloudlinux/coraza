...
func (m *mockTransaction) Global() collection.Persistent                   { return nil }
func (m *mockTransaction) Resource() collection.Persistent                 { return nil }
func (m *mockTransaction) User() collection.Persistent                     { return nil }
func (m *mockTransaction) Session() collection.Persistent                  { return nil }
func (m *mockTransaction) IP() collection.Persistent                       { return nil }
func (m *mockTransaction) ScriptFilename() collection.Single               { return nil }
func (m *mockTransaction) ScriptUsername() collection.Single               { return nil }
